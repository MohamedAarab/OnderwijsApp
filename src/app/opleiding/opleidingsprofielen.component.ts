...
@Component({
  templateUrl: 'opleidingsprofielen.component.html',
})
export class OpleidingsprofielenComponent implements OnInit {
  ...
  constructor(private cursusService: OpleidingsprofielenService) {
    this.loading = true;
  }

  ngOnInit(): void {
    this.selectedButton = 1;
    this.cursusService.getOpleidingsprofielen().subscribe(opleidingsprofielen => {
        this.courses = opleidingsprofielen;
